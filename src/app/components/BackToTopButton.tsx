  ...
  return (
    <button
      ...
      style={{
        ...
        background: isDark ? "rgba(35,38,36,0.74)" : "rgba(241,241,241,0.72)",
        border: `1px solid ${isDark ? "rgba(241,241,241,0.14)" : "rgba(35,38,36,0.13)"}`,
        boxShadow: isDark
          ? "0 14px 42px rgba(0,0,0,0.34), 0 0 30px rgba(223,244,64,0.075), 0 0 18px rgba(75,129,151,0.08)"
          : "0 14px 38px rgba(35,38,36,0.11), 0 0 28px rgba(75,129,151,0.065), 0 0 16px rgba(223,244,64,0.06)",
      }}
    >
      <span
        aria-hidden="true"
        ...
        style={{
          background: isDark
            ? "radial-gradient(circle, rgba(223,244,64,0.13), rgba(75,129,151,0.14), transparent 72%)"
            : "radial-gradient(circle, rgba(75,129,151,0.11), rgba(223,244,64,0.07), transparent 72%)",
        }}
      />
      <ArrowUp
        size={16}
