...
const palettes = {
  ...
  light: {
    ...
    containerShadow: "0 0 100px rgba(0,0,0,0.06), inset 0 1px 0 rgba(255,255,255,0.8), 0 0 40px rgba(107,143,58,0.04)",
    text: "#1a1a1a",
    textInvert: "#ffffff",
    textBase: "0,0,0",
    surfaceBase: "0,0,0",
    ...
    ctaBg: "linear-gradient(160deg, rgba(107,143,58,0.08) 0%, rgba(245,243,240,0.98) 40%, rgba(250,248,245,0.99) 100%)",
