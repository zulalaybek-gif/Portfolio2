import svgPaths from "./svg-xwksb4312z";
...
import imgDownload14 from "figma:asset/a7bba70ca38b090a36094a628b6f8074cce794b4.png";
import imgDownload15 from "figma:asset/695579629e0aab6f5abd699457193e7d913b502b.png";
...
export default function InstagramStory() {
  return (
    <div className="bg-[#a595c7] relative size-full" data-name="Instagram story - 40">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[1880px] left-[calc(50%-0.5px)] rounded-[12px] top-1/2 w-[1035px]" data-name="download 12">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[12px]">
          ...
          <div className="absolute inset-0 overflow-hidden rounded-[12px]">
            <img alt="" className="absolute h-full left-[-120.18%] max-w-none top-0 w-[323.33%]" src={imgDownload14} />
          </div>
          <div className="absolute inset-0 overflow-hidden rounded-[12px]">
            <img alt="" className="absolute h-[203.53%] left-[-38%] max-w-none top-[-5.12%] w-[155.24%]" src={imgDownload15} />
          </div>
        </div>
      </div>
      <div className="-translate-x-1/2 absolute bg-[rgba(71,62,88,0.34)] h-[1745.119px] left-[calc(50%-0.5px)] rounded-bl-[8px] rounded-br-[8px] top-[87.44px] w-[900.889px]" />
      <div className="absolute bg-[#a595c7] h-[438.436px] left-[132.81px] shadow-[0px_1px_6px_0px_rgba(0,0,0,0.1)] top-[591.27px] w-[813.389px]" />
      <p className="-translate-x-1/2 absolute font-['Founders_Grotesk:Medium',sans-serif] h-[357.078px] leading-[normal] left-1/2 not-italic text-[64px] text-center text-white top-[631.95px] uppercase w-[792.553px]">Une assemblée générale ordinaire conviviale et riche d’échanges constructifs</p>
      <Group />
    </div>
  );
}